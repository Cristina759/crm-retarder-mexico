...
export const VENTAS_REALES: VentaReal[] = [
    ...
    { id: '13', cliente: 'MAPLE TRANSPORTES Y SERVICIOS', orden_servicio: '', factura: 'B569', mano_obra: 12894, refacciones: 335156, gastos_traslado: 27508, subtotal: 375558, iva: 60089.28, total: 435647.28, pagado: true },
    ...
    { id: '20', cliente: 'LA CANTERA', orden_servicio: '492', factura: 'B576', mano_obra: 4750, refacciones: 1690.8, gastos_traslado: 2500, subtotal: 8940.8, iva: 1430.53, total: 10371.33, pagado: true },
    { id: '21', cliente: 'PROMACO', orden_servicio: '618', factura: 'B578', mano_obra: 4530.4, refacciones: 0, gastos_traslado: 7000, subtotal: 11530.4, iva: 1844.86, total: 13375.26, pagado: true },
    { id: '22', cliente: 'PROMACO', orden_servicio: '617', factura: 'B579', mano_obra: 7250, refacciones: 19810.72, gastos_traslado: 7000, subtotal: 34060.72, iva: 5449.72, total: 39510.44, pagado: true },
    { id: '23', cliente: 'PROMACO', orden_servicio: '', factura: 'B580', mano_obra: 8500, refacciones: 0, gastos_traslado: 14000, subtotal: 22500, iva: 3600, total: 26100, pagado: true },
    { id: '24', cliente: 'ZEMER CONSTRUCTORA', orden_servicio: 'N/A', factura: 'B581', mano_obra: 0, refacciones: 5826.43, gastos_traslado: 0, subtotal: 5826.43, iva: 932.23, total: 6758.66, pagado: false },
    { id: '25', cliente: 'VERSA PERFORACIONES', orden_servicio: '549, 550, 551, 552', factura: 'B582', mano_obra: 20150, refacciones: 5160.43, gastos_traslado: 10000, subtotal: 35310.43, iva: 5649.67, total: 40960.1, pagado: true },
    { id: '26', cliente: 'DENISSE PERLETTE ALVAREZ CRUZ', orden_servicio: '', factura: 'B583', mano_obra: 4250, refacciones: 0, gastos_traslado: 2500, subtotal: 6750, iva: 1080, total: 7830, pagado: false },
    { id: '27', cliente: 'LA CANTERA TIZAPA', orden_servicio: '', factura: 'B584', mano_obra: 0, refacciones: 154315.34, gastos_traslado: 0, subtotal: 154315.34, iva: 24690.45, total: 179005.79, pagado: false },
];
