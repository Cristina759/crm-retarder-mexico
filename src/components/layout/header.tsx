                                ...
                                >
                                    <div className="flex items-center justify-between mb-3 border-b border-retarder-gray-100 pb-2 shrink-0">
                                        ...
                                        {notifications.length > 0 && (
                                            <button
                                                ...
                                                title="Marcar todas como ledas"
                                            >
                                                <CheckCheck size={14} /> Ledas
                                            </button>
                                        )}
                                    </div>
                                    <div className="space-y-1 overflow-y-auto pr-1 kanban-scroll flex-1 -mr-2">
                                        {notifications.length > 0 ? (
                                            ...
                                            <p className="text-xs text-retarder-gray-400 text-center py-6">Ests al da.<br />No hay notificaciones nuevas.</p>
                                        )}
                                    </div>
                                </motion.div>
                            )}
