...
export default function CotizacionesPage() {
    ...
    const handleDelete = useCallback((id: string) => {
        ...
        setTimeout(async () => {
            if (!await confirmModal('Â¿Estás seguro de que deseas eliminar esta cotización? Esto también eliminará cualquier Orden de Servicio vinculada. Esta acción no se puede deshacer.')) return;
