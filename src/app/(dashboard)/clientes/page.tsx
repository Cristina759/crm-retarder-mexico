...
export default function ClientesPage() {
    ...
    async function handleDelete(id: string) {
        if (!await confirmModal('Â¿Estás seguro de que deseas eliminar este cliente? Esta acción no se puede deshacer.')) return;
    ...
    async function handleSave() {
        ...
        if (!supabaseUrl || !supabaseKey) {
            toast.error('ERROR CRÃTICO: Las variables de entorno de Supabase no están configuradas en Vercel. Por favor contacta al administrador.');
            return;
        }
