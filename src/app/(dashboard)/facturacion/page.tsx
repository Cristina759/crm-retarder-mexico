...
export default function FacturacionPage() {
    ...
    const handleCreateFactura = async () => {
        if (!newFactura.numero_factura || !newFactura.empresa) {
            toast.error('Por favor completa los campos obligatorios (Nmero de factura y Empresa)');
            return;
        }
            ...
            if (newFactura.orden_id) {
                ...
                const { error } = await supabase
                    ...
                    .insert([{
                        ...
                        numero_factura: newFactura.numero_factura,
                        estado: 'facturado',
                        descripcion: newFactura.concepto || 'Facturacin Manual',
        ...
        try {
            ...
            if (nuevoEstado === 'pagada') {
                ...
                if (!numeroFactura || numeroFactura === 'PENDIENTE') {
                    const input = await promptModal('Ingresa el nmero de factura antes de marcar como pagada:');
                ...
                const numeroFactura = await promptModal('Ingresa el nmero de factura (ej. F-0001):');
    ...
    return (
        <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                    <h2 className="text-xl font-bold text-retarder-black">Facturacin</h2>
                    ...
                    <>
                        ...
                        <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 20 }} className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg bg-white rounded-2xl shadow-2xl z-50 overflow-hidden">
                            ...
                            <div className="px-6 py-5 space-y-4 max-h-[70vh] overflow-y-auto">
                                ...
                                <div>
                                    <label className="text-[10px] font-semibold uppercase tracking-wider text-retarder-gray-400 mb-1 block">Nmero de Factura</label>
                                ...
                                <div>
                                    ...
                                    <textarea 
                                        placeholder="Descripcin de la factura..." 
                                        rows={2} 
