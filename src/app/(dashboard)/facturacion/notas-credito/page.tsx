...
export default function NotasCreditoPage() {
    ...
    // Fetch notas de crdito from Supabase
    ...
    // Create nota de crdito in Supabase
    ...
    const handleDelete = async (id: string) => {
        if (!await confirmModal('Ests seguro de eliminar esta nota de crdito?')) return;
        ...
        <div className="space-y-4">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                    <div className="flex items-center gap-2">
                        ...
                        <div>
                            <h2 className="text-xl font-bold text-retarder-black">Notas de Crdito</h2>
            ...
            >
                ...
                <p className="text-xs text-amber-800">
                    <strong>Las notas de crdito no se suman al total facturado de ventas.</strong>{' '}
                                ...
                                <tr>
                                    <td colSpan={8} className="py-16 text-center">
                                        <div className="flex flex-col items-center gap-3">
                                            ...
                                            <div>
                                                <p className="text-sm font-semibold text-retarder-gray-600">No hay notas de crdito</p>
                                                <p className="text-xs text-retarder-gray-400 mt-0.5">Crea tu primera nota de crdito para comenzar</p>
                                            </div>
                                            <button
                                                onClick={() => setShowForm(true)}
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between px-6 py-4 border-b border-retarder-gray-200 bg-gradient-to-r from-orange-500 to-red-600">
                                <div>
                                    ...
                                    <p className="text-xs text-white/70">Nota de Crdito</p>
                                </div>
                            ...
                            <div className="p-6 space-y-5">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <div className="bg-retarder-gray-50 rounded-xl p-3">
                                        <p className="text-[10px] font-semibold uppercase text-retarder-gray-400">Fecha Emisin</p>
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between px-6 py-4 border-b border-retarder-gray-200 bg-gradient-to-r from-orange-500 to-red-600">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-bold text-white">Nueva Nota de Crdito</h3>
