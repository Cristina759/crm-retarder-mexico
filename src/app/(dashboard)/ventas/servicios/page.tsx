...
// â”€â”€ Service Type Definitions â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const SERVICE_TYPES: ServiceType[] = [
    {
        ...
        description: 'RevisiÃ³n completa del sistema con checklist detallado',
        allowRefacciones: false,
        checklist: [
            {
                title: 'Sistema MecÃ¡nico',
                items: [
                    'Torque a tornillerÃ­a',
                    'Limpieza de panel de conexiones',
                    'Placas laterales',
                    'Hules y tornillerÃ­a en general',
                    'RevisiÃ³n cardanes y crucetas',
                ],
            },
            {
                title: 'Engrase',
                items: ['Engrase segÃºn marca (tubo incluido)'],
            },
            {
    ...
    },
    {
        ...
        description: 'DiagnÃ³stico de falla, reparaciÃ³n y refacciones',
        allowRefacciones: true,
        checklist: [
            {
                title: 'Servicio Correctivo',
                items: [
                    'DiagnÃ³stico de falla',
                    'ReparaciÃ³n',
                    'Refacciones (se agregan del catÃ¡logo)',
                ],
            },
        ],
    },
...
// â”€â”€ Precio Fijo Preventivo â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
const PRECIO_PREVENTIVO = 4250;

// â”€â”€ Refaccion Cart Item â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Mano de Obra Item â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Price Line Component (PDF Only) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export default function CotizadorServiciosPage() {
    ...
    // Carga de Clientes desde lista estÃ¡tica
            ...
            try {
                ...
                await supabase
                    ...
                    .insert({
                        ...
                        vendedor: sellerName,
                        tecnico: '',
                        descripcion: `Servicio ${selectedService.label}. CotizaciÃ³n: ${cotNumero}.`,
                        monto: total,
    ...
    return (
        <div className="space-y-6 pb-12">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 print:hidden">
                <div>
                    ...
                    <p className="text-xs text-retarder-gray-500">
                        Selecciona el tipo de servicio y genera la cotizaciÃ³n automÃ¡ticamente
                    </p>
                </div>
            ...
            {/* â”€â”€ Service Type Cards â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
            ...
            {/* â”€â”€ Main Section (UI and Print Hidden) â”€ */}
                    ...
                    <motion.div key={selectedService.id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="print:hidden">
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div className="lg:col-span-2 space-y-5">
                                {savedFolio && (
                                    <div className="mb-6 bg-green-50 border border-green-200 rounded-3xl p-6 flex items-center justify-between animate-in fade-in slide-in-from-top-4 duration-500">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <p className="text-green-800 font-black text-lg uppercase tracking-tight">Â¡CotizaciÃ³n Guardada!</p>
                                                <p className="text-green-600 font-bold text-xs uppercase opacity-80">Folio: {savedFolio} Â· Orden Creada</p>
                                            </div>
                                        </div>
                                        <button 
                                            onClick={() => {
                                ...
                                <div className="bg-white rounded-2xl border border-retarder-gray-200 overflow-hidden shadow-sm p-6 space-y-6">
                                    ...
                                    <div className="space-y-1.5 pt-4">
                                        ...
                                        <textarea
                                            ...
                                            placeholder="Detalles especÃ­ficos del servicio para este cliente..."
                                    ...
                                    {savedFolio ? (
                                        ...
                                        <div className="space-y-4">
                                            <div className="flex items-center gap-3 px-1">
                                                ...
                                                />
                                                <label htmlFor="autoPrintSrv" className="text-xs font-bold text-white/60 cursor-pointer uppercase tracking-tight">Imprimir automÃ¡ticamente al guardar</label>
                                            </div>
            ...
            {/* â”€â”€ PROFESSIONAL PRINT AREA (PDF ONLY) â”€â”€ */}
            <AnimatePresence>
                {selectedService && (
                    <div className="print-area hidden print:block bg-white p-0">
                        <div className="max-w-[800px] mx-auto bg-white overflow-hidden">
                            ...
                            <div className="flex items-center justify-between px-8 py-6 border-b-4 border-retarder-red">
                                <div><img src="/logo-retarder.png" alt="Retarder MÃ©xico Logo" className="h-24 object-contain" /></div>
                                <div className="text-right">
                                    <h2 className="text-xl font-black text-retarder-black tracking-tight uppercase">RETARDER MÃ‰XICO</h2>
                                    <p className="text-xs text-retarder-gray-500 font-medium">CotizaciÃ³n de Servicios</p>
                                    ...
                                    <div className="space-y-2">
                                        {selectedService.checklist.map(group => (
                                            <div key={group.title}>
                                                ...
                                                <ul className="grid grid-cols-1 gap-0.5">{group.items.map(i => (<li key={i} className="text-[8px] flex items-start gap-1"><span className="text-retarder-red mt-0.5">â€¢</span>{i}</li>))}</ul>
                                            </div>
                                        ))}
                                    </div>
                                </div>
                                <div className="space-y-6">
                                    <h5 className="text-[9px] font-black uppercase border-b-2 border-retarder-gray-800 pb-1 mb-3 tracking-widest">Desglose EconÃ³mico:</h5>
                                    <div className="space-y-1">
                            ...
                            <div className="px-8 py-4 mt-8">
                                <div className="mb-4">
                                    <p className="text-[9px] font-black text-retarder-black uppercase mb-1 tracking-wider border-b border-retarder-gray-100 pb-1">Observaciones TÃ©cnicas / LogÃ­sticas:</p>
                                ...
                                <div className="mb-4">
                                    <p className="text-[9px] font-black text-retarder-red uppercase mb-1 tracking-wider">PolÃ­ticas y GarantÃ­as:</p>
                            ...
                            <div className="px-8 py-10 border-t border-retarder-gray-100 flex justify-between items-end mt-12 mb-8">
                                <div><p className="text-[10px] font-black text-retarder-black leading-none">{user?.fullName || 'CRISTINA VELASCO'}</p><p className="text-[8px] text-retarder-gray-500 uppercase mt-1 tracking-widest">Ãrea TÃ©cnica y Comercial</p><p className="text-[8px] text-retarder-red font-black mt-1">TEL. 55-7372-1633</p></div>
            ...
            {/* â”€â”€ Refacciones Modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
            <AnimatePresence>
                {showRefSearch && (
                    <>
