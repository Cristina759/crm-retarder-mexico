...
const ESTADO_PIPELINE: { id: OppEstado; label: string; color: string; bgLight: string; textColor: string }[] = [
    ...
    { id: 'negociacion', label: 'NegociaciÛn', color: 'bg-amber-500', bgLight: 'bg-amber-50', textColor: 'text-amber-700' },
...
const DEMO_OPORTUNIDADES: DemoOportunidad[] = [
    ...
    { id: '4', empresa: 'LogiTrax', vendedor: 'Pedro V.', tipo: 'frenos', descripcion: 'Retarder P7 para camiÛn nuevo', estado: 'prospecto', monto_estimado: 120000, probabilidad: 15, fecha: '2026-02-14' },
    { id: '5', empresa: 'MegaFletes SA', vendedor: 'Ana G.', tipo: 'servicios', descripcion: 'DiagnÛstico flota completa 20 unidades', estado: 'ganada', monto_estimado: 180000, probabilidad: 100, fecha: '2026-01-28' },
    ...
    { id: '7', empresa: 'R·pidos del BajÌo', vendedor: 'Ana G.', tipo: 'refacciones', descripcion: 'Stock anual placas y tornillerÌa', estado: 'cotizado', monto_estimado: 65000, probabilidad: 40, fecha: '2026-02-07' },
    { id: '8', empresa: 'Transportes Sierra', vendedor: 'Pedro V.', tipo: 'servicios', descripcion: 'InstalaciÛn 5 unidades', estado: 'perdida', monto_estimado: 275000, probabilidad: 0, fecha: '2026-01-15' },
    { id: '9', empresa: 'LogÌstica Global', vendedor: 'Ana G.', tipo: 'frenos', descripcion: 'Retarder P5-1 para 8 tractocamiones', estado: 'ganada', monto_estimado: 720000, probabilidad: 100, fecha: '2026-01-20' },
    { id: '10', empresa: 'Auto Transportes LP', vendedor: 'Pedro V.', tipo: 'refacciones', descripcion: 'Card·n + material elÈctrico', estado: 'prospecto', monto_estimado: 42000, probabilidad: 10, fecha: '2026-02-15' },
];
                    ...
                    <>
                        ...
                        <motion.div initial={{ opacity: 0, scale: 0.95, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} exit={{ opacity: 0, scale: 0.95, y: 20 }} className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-lg bg-white rounded-2xl shadow-2xl z-50 overflow-hidden">
                            ...
                            <div className="px-6 py-5 space-y-4 max-h-[60vh] overflow-y-auto">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div>
                                        ...
                                        <select className="w-full border border-retarder-gray-200 rounded-lg px-3 py-2.5 text-sm focus:border-retarder-red focus:ring-2 focus:ring-retarder-red/10 outline-none">
                                            <option value="frenos">üî¥ Frenos</option>
                                            <option value="refacciones">üîß Refacciones</option>
                                ...
                                <div>
                                    <label className="text-[10px] font-semibold uppercase tracking-wider text-retarder-gray-400 mb-1 block">DescripciÛn</label>
